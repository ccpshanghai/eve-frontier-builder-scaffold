...
describe("OwnerControls", () => {
  ...
  it("shows compact authorize banner when owner and not authorized", () => {
    ...
    const banner = screen
      .getByText("EXTENSION NOT AUTHORIZED")
      .closest(".st-auth-banner");
  ...
  it("renders nothing when owner and authorized", () => {
    ...
    expect(container.innerHTML).toBe("");
    expect(screen.queryByText("EXTENSION AUTHORIZED")).toBeNull();
